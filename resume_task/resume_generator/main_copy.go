...
type ResumeData struct {
    ...
    StudentDegree               string  `json:"studentdegree"`
    StudentCollege              string  `json:"studentcollege"`
    ...
    StudentObjective            string `json:"studentobjective"`

    StudentDegreeYear           string `json:"studentdegreeyear"`
    StudentDegreePercentage     string `json:"studentdegreepercentage"`
    
    StudentTwelfthYear          string `json:"studenttwelfthyear"`
    StudentTwelfthPercentage    string `json:"studenttwelfthpercentage"`
    StudentTwelfthSchool        string `json:"studenttwelfthschool"`

    StudentTenthYear            string `json:"studenttenthyear"`
    StudentTenthPercentage      string `json:"studenttenthpercentage"`
    StudentTenthSchool          string `json:"studenttenthschool"`
